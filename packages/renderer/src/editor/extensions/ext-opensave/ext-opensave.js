...
export default {
    ...
    async init(_S) {
        ...
        <se-menu-item id="tool_clear" label="opensave.new_doc" shortcut="N" src="new.svg"></se-menu-item>`;
                ...
                const openButtonTemplate =
                    '<se-menu-item id="tool_open" label="opensave.open_image_doc" src="open.svg"></se-menu-item>';
                svgCanvas.insertChildAtIndex($id("main_button"), openButtonTemplate, 1);
                const saveButtonTemplate =
                    '<se-menu-item id="tool_save" label="opensave.save_doc" shortcut="S" src="saveImg.svg"></se-menu-item>';
                svgCanvas.insertChildAtIndex($id("main_button"), saveButtonTemplate, 2);
                const saveAsButtonTemplate =
                    '<se-menu-item id="tool_save_as" label="opensave.save_as_doc" src="saveImg.svg"></se-menu-item>';
                svgCanvas.insertChildAtIndex($id("main_button"), saveAsButtonTemplate, 3);
                const importButtonTemplate =
