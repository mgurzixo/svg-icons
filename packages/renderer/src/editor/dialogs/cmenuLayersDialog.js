/* globals svgEditor */
import cMenuLayersDialog from "./cmenuLayersDialog.html.js";
...
export class SeCMenuLayerDialog extends HTMLElement {
    ...
    connectedCallback() {
        ...
        svgEditor.$click(this.$duplicateLink, (evt) =>
            onMenuClickHandler(evt, "dupe", this.source)
        );
        svgEditor.$click(this.$deleteLink, (evt) => onMenuClickHandler(evt, "delete", this.source));
        svgEditor.$click(this.$mergeDownLink, (evt) =>
            onMenuClickHandler(evt, "merge_down", this.source)
        );
        svgEditor.$click(this.$mergeAllLink, (evt) =>
            onMenuClickHandler(evt, "merge_all", this.source)
        );
    }
}
