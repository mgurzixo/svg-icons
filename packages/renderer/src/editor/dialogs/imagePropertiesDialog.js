...
import imagePropertiesDialogHTML from "./imagePropertiesDialog.html.js";
...
export class SeImgPropDialog extends HTMLElement {
    ...
    static get observedAttributes() {
        return [
            ...
            "common-width",
            "common-height",
            "config-select_predefined",
            "tools-fit-to-content",
            "config-included_images",
            "config-image_opt_embed",
        ...
        switch (name) {
            ...
            case "embed":
                if (newValue.includes("one")) {
                    ...
                    if (data.length > 1) {
                        this._shadowRoot
                            .querySelector("#image_opt_embed")
                            .setAttribute("title", data[1]);
                        this._shadowRoot
                            .querySelector("#image_opt_embed")
