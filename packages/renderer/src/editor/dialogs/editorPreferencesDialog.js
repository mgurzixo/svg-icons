/* globals svgEditor */
import editorPreferencesDialog from "./editorPreferencesDialog.html.js";
...
export class SeEditPrefsDialog extends HTMLElement {
    ...
    static get observedAttributes() {
        ...
        return [
            ...
            "config-background",
            "common-url",
            "config-editor_bg_note",
            "config-grid",
            "config-snapping_onoff",
            "config-snapping_stepsize",
            "config-grid_color",
            "config-units_and_rulers",
            "config-show_rulers",
            "config-base_unit",
        ];
    }
        ...
        this.colorBlocks.forEach(function (e) {
            ...
            if (e === "chessboard") {
                ...
                newdiv.style.backgroundImage =
                    "url(data:image/gif;base64,R0lGODlhEAAQAIAAAP///9bW1iH5BAAAAAAALAAAAAAQABAAAAIfjG+gq4jM3IFLJgpswNly/XkcBpIiVaInlLJr9FZWAQA7)";
